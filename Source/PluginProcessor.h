...
public:
    ...
    // The added member variables for this plugin
    float mLevel,mFinalLevel, mKSig1,mKSig2, mDSig,mDSig2, mWD, mGValve, mDTan,mRTan, mDCasPar;
    bool mParallelOn;

private:
// Declaring a create parameter function
